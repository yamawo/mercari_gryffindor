$(function(){
  ...
  let html = `<select class="category_children" name="q[category_id]" id="q_category_id">`
  return html;
  };

  let get_HTML_indirects = function(){
  let html = `<select class="category_indirects" name="q[category_id]" id="q_category_id">`
  return html;
  };
